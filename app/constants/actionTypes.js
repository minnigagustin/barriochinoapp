...
export const LISTING_COUPON = "LISTING_COUPON";
...
export const LISTING_CUSTOM_SECTION = "LISTING_CUSTOM_SECTION";
export const GET_LISTING_ARTICLE = "GET_LISTING_ARTICLE";
export const GET_LISTING_ARTICLE_ALL = "GET_LISTING_ARTICLE_ALL";
export const GET_LISTING_SINGLE_PRODUCT = "GET_LISTING_SINGLE_PRODUCT";
export const ADD_TO_CART_LISTING = "ADD_TO_CART_LISTING";
export const REMOVE_TO_CART_LISTING = "REMOVE_TO_CART_LISTING";
export const GET_LISTING_MULTIPLE_PRODUCT = "GET_LISTING_MULTIPLE_PRODUCT";
export const CHANGE_QUANTITY_LISTING = "CHANGE_QUANTITY_LISTING";
export const LISTING_TAXONOMY = "LISTING_TAXONOMY";
export const UNLOCK_OTP = "UNLOCK_OTP";
