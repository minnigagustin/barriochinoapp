  ...
  render() {
    ...
    return (
      <View style={[containerStyle]}>
        ...
        <View style={{flexDirection:'row',justifyContent:'space-between', width: 50,justifyContent: "center", alignItems: "center"}}>
        <TouchableOpacity
        style={{
    zIndex: 15,
    right: 10,
    ...
    margin: 3,
    borderRadius: 50,
    backgroundColor: this.state.selectCatg == 1 ? "#f8bd00": 'gray',
    ...
    height: 10,
    borderRadius: 50,
    backgroundColor: this.state.selectCatg == 2 ? "#f8bd00": 'gray' ,
    justifyContent: "center",
    alignItems: "center",
    }}
