      ...
      case "inputText":
        return (
          <InputMaterial
            ...
            inputStyle={item.multiline && { maxHeight: 170 }}
            onFocus={() => {
              this.setState({
                indexFocus: index,
              });
            ...
            <View
              style={{
                ...
                bottom:
                  indexFocus > 3
                    ? Platform.OS === "android"
                      ? keyboardHeight / 7 + (keyboardHeight ? 100 : 0)
                      : keyboardHeight / 3
                    : 0,
              }}
            >
              <View style={[styles.container, style]}>
                ...
                {!_.isEmpty(data) &&
                  Object.keys(data).map((key, index) => (
                    <View key={key}>{this._renderItem(data)(key, index)}</View>
                  ))}
              </View>
            </View>
          );
